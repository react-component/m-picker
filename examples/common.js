...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"cityPicker","1":"simple"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vendorScroller = __webpack_require__(165);
	
	var _vendorScroller2 = _interopRequireDefault(_vendorScroller);
	...
	var MCascadeSelect = _react2['default'].createClass({
	  ...
	  onSelect: function onSelect(index, selectVal) {
	  ...
	  createScrollerContainer: function createScrollerContainer() {
	    var _this = this;
	    ...
	    this.data.forEach(function (item, index) {
	      var ref = 'scroll_' + index;
	      html += '<div id="' + ref + '" class="' + props.prefixCls + '-item" data-index="' + index + '"></div>';
	
	      scrollers.push({
	        el: '#' + ref,
	        data: item,
	        defaultValue: _this.value[index],
	        onSelect: _this.onSelect.bind(_this, index)
	      });
	    });
	    ...
	    scrollers.forEach(function (item) {
	      ...
	      _this.initScroller(el, data, defaultValue, onSelect);
	    });
	  },
	  createSelector: function createSelector() {
	    ...
	    var container = _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: props.prefixCls + '-item', onClick: this.onSubmit },
	          '完成'
	        )
	      ),
	      _react2['default'].createElement('div', { id: '__scrolls_wrapper', className: props.prefixCls + '-content' })
	    );
	
	    var maskCls = props.prefixCls + '-mask';
	    var maskOpenCls = state.open ? props.prefixCls + '-mask-open' : '';
	    var mask = _react2['default'].createElement('div', { className: (0, _classnames2['default'])(maskCls, maskOpenCls), onClick: this.onClose });
	  ...
	  initScroller: function initScroller(el, data, defaultValue, onSelect) {
	    var prefixCls = this.props.prefixCls;
	    // destroy each scroller, is it required ??
	    this.scrollerInstances = [];
	    var scroller = new _vendorScroller2['default'](el, {
	  ...
	  processDataAndValue: function processDataAndValue() {
	    // init data and value：
	    //
	    ...
	    this.value = value;
	    this.data = this.props.data.map(function (item, index) {
	      var newItem = item;
	      if (!item.length) {
	        newItem = [{ value: '', name: '' }];
	      }
	      ...
	      var existing = newItem.some(function (ii) {
...
/***/ function(module, exports) {
	...
	var TEMPLATE = '<div class="scroller-component" data-role="component"> \
